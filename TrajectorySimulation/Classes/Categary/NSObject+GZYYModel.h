 ...
 * Implementations of `NSCoding`, `NSCopying`, `-hash` and `-isEqual:`.
 ...
 See `GZYYModel` protocol for custom methods.
 
 
 Sample Code:
    
     ********************** json convertor *********************
     @interface GZYYAuthor : NSObject
     @property (nonatomic, strong) NSString *name;
     @property (nonatomic, assign) NSDate *birthday;
     @end
     @implementation GZYYAuthor
     @end
 
     @interface GZYYBook : NSObject
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) NSUInteger pages;
     @property (nonatomic, strong) GZYYAuthor *author;
     @end
     @implementation GZYYBook
     @end
    
     int main() {
         // create model from json
         GZYYBook *book = [GZYYBook GZYY_modelWithJSON:@"{\"name\": \"Harry Potter\", \"pages\": 256, \"author\": {\"name\": \"J.K.Rowling\", \"birthday\": \"1965-07-31\" }}"];
 
         // convert model to json
         NSString *json = [book GZYY_modelToJSONString];
         // {"author":{"name":"J.K.Rowling","birthday":"1965-07-31T00:00:00+0000"},"name":"Harry Potter","pages":256}
     }
 
     ********************** Coding/Copying/hash/equal *********************
     @interface GZYYShadow :NSObject <NSCoding, NSCopying>
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) CGSize size;
     @end
 
     @implementation GZYYShadow
     - (void)encodeWithCoder:(NSCoder *)aCoder { [self GZYY_modelEncodeWithCoder:aCoder]; }
     - (id)initWithCoder:(NSCoder *)aDecoder { self = [super init]; return [self GZYY_modelInitWithCoder:aDecoder]; }
     - (id)copyWithZone:(NSZone *)zone { return [self GZYY_modelCopy]; }
     - (NSUInteger)hash { return [self GZYY_modelHash]; }
     - (BOOL)isEqual:(id)object { return [self GZYY_modelIsEqual:object]; }
     @end
 
 */
@interface NSObject (GZYYModel)
 ...
 */
+ (nullable instancetype)GZYY_modelWithJSON:(id)json;
...
/**
 ...
 property, this method will try to convert the value based on these rules:
     ...
     `NSString` -> NSDate, parsed with format "GZYYGZYY-MM-dd'T'HH:mm:ssZ", "GZYYGZYY-MM-dd HH:mm:ss" or "GZYYGZYY-MM-dd".
     `NSString` -> NSURL.
     `NSValue` -> struct or union, such as CGRect, CGSize, ...
     `NSString` -> SEL, Class.
 */
+ (nullable instancetype)GZYY_modelWithDictionary:(NSDictionary *)dictionary;
 ...
 */
- (BOOL)GZYY_modelSetWithJSON:(id)json;
...
/**
 ...
 @return Whether succeed.
 */
- (BOOL)GZYY_modelSetWithDictionary:(NSDictionary *)dic;
 ...
 */
- (nullable id)GZYY_modelToJSONObject;
 ...
 */
- (nullable NSData *)GZYY_modelToJSONData;
...
/**
 ...
 inner object to json string.
 */
- (nullable NSString *)GZYY_modelToJSONString;
 ...
 */
- (void)GZYY_modelEncodeWithCoder:(NSCoder *)aCoder;
...
/**
 ...
 @return self
 */
- (id)GZYY_modelInitWithCoder:(NSCoder *)aDecoder;
 ...
 */
- (BOOL)GZYY_modelIsEqual:(id)model;
 ...
 */
- (NSString *)GZYY_modelDescription;
 ...
 */
+ (nullable NSArray *)GZYY_modelArrayWithClass:(Class)cls json:(id)json;
 ...
 */
@interface NSDictionary (GZYYModel)
 ...
 */
+ (nullable NSDictionary *)GZYY_modelDictionaryWithClass:(Class)cls json:(id)json;
@end
...
/**
 ...
 There's no need to add '<GZYYModel>' to your class header.
 */
@protocol GZYYModel <NSObject>
@optional
...
/**
 ...
 object will be add to the array/set/dictionary.
  ...
  Example:
        @class GZYYShadow, GZYYBorder, GZYYAttachment;
 
        @interface GZYYAttributes
        @property NSString *name;
        ...
        @implementation GZYYAttributes
        + (NSDictionary *)modelContainerPropertyGenericClass {
            return @{@"shadows" : [GZYYShadow class],
                     @"borders" : GZYYBorder.class,
                     @"attachments" : @"GZYYAttachment" };
        }
        @end
...
/**
 ...
 Example:
        @class GZYYCircle, GZYYRectangle, GZYYLine;
 
        @implementation GZYYShape

        + (Class)modelCustomClassForDictionary:(NSDictionary*)dictionary {
            if (dictionary[@"radius"] != nil) {
                return [GZYYCircle class];
            } else if (dictionary[@"width"] != nil) {
                return [GZYYRectangle class];
            } else if (dictionary[@"y2"] != nil) {
                return [GZYYLine class];
            } else {
                return [self class];
            }
        }
